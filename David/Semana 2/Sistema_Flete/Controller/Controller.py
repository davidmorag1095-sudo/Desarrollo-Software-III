...
from Semana2.Sistema_Flete.Model.RepositorioModel import Repositorio
from Semana2.Sistema_Flete.Model.ClienteModel import Cliente
from Semana2.Sistema_Flete.Model.FleteModel import Flete
class Controller:
    # -----------------------------------------------------------------------
    #Constructor
    def __init__(self):
